...
<div class="card col-md-5 offset-md-4 p-2 mt-3 bg-white">
    <div class="card-header bg-dark text-white text-center mb-1"><h4>Login</h4></div>
<form action="loginprocess.php" method="POST" class="form ml-5 mr-5 mt-4">
 ...
 <span>You are not yet a memmber? </span><a href="admin_register.php">Sign-up</a>
